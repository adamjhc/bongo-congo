...
public class PreLevelEditor implements IGui {
  ...
  public PreLevelEditor() {
    ...
    bongo.getMesh().getMaterial().setColour(Colour.LIGHT_BLUE);

    TextObject congo = new TextObject("Congo", TITLE);
    congo.getMesh().getMaterial().setColour(Colour.RED);

    TextObject editor = new TextObject("Level Editor", SMALL);
    editor.setColour(Colour.YELLOW);
    ...
    separatorBottom.setColour(Colour.YELLOW);
  ...
  public void incWidth() {
    ...
    this.wNum.getMesh().getMaterial().setColour(Colour.YELLOW);
  }
  ...
  public void incLength() {
    ...
    this.lNum.getMesh().getMaterial().setColour(Colour.YELLOW);
  }
  ...
  public void incHeight() {
    ...
    this.hNum.getMesh().getMaterial().setColour(Colour.YELLOW);
  }
