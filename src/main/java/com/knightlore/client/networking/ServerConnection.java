...
public class ServerConnection {
  ...
  public static boolean makeConnection() throws ConfigItemNotFoundException {
    ...
    if (authServerIp.isPresent() && authServerPort.isPresent()) {
      ...
      try {
        authClient =
            new com.knightlore.client.networking.backend.Client(
                InetAddress.getByName(authServerIp.get()), authServerPort.get());
        if (!authClient.run()) {
          return false;
        }
   ...
   */
  public void auth()
      throws ClientAlreadyAuthenticatedException, IOException, ConfigItemNotFoundException {
  ...
  public void requestGame() {
    if (this.authenticated) {
      ...
      com.knightlore.networking.server.GameRequest request =
          new com.knightlore.networking.server.GameRequest();
