...
public class CirclerAI {
  ...
  /**
   * Calculates next position for the Circler to move to. This is done by
   * using the spawn point of the enemy with circle geometry to move them
  ...
  /**
   * Returns which way the enemy should be facing based on
   * what angle of the circle they are at.
   * @param angle
