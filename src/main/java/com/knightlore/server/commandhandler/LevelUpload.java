...
public class LevelUpload extends Command {
  ...
  static final Logger logger = Logger.getLogger(LevelUpload.class);
  ...
  public void run(ClientHandler handler, Sendable sendable) {
    ...
    levelModel.setAttribute(
        "created_by", (int) currentTokenModel.get().getAttribute("registration_key_id"));
